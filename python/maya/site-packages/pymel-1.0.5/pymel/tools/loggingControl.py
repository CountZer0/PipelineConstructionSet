    ...
    def buildSubMenu(self, parent, logger):
        ...
        try:
            if logger.children:
                ...
                for item in logger.children:
                    ...
                    subMenu.setPostMenuCommand(pymel.Callback(self.buildSubMenu, parent=subMenu, logger=item)) #J.Parks Edit
        ...
        if logger.handlers:
            ...
            for item in logger.handlers:
                ...
                pymel.menuItem(l="Remove", p=levelsMenu, ob=True, c=pymel.Callback(logger.removeHandler, item)) # J.parks Edit
