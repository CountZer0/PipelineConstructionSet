        ...
        try:
            if returnType is not None:
                ...
                # Other: ensure we can cast result
                    ...
                    if not self.apiClassName == 'MTransformationMatrix' and not returnType == 'MQuaternion': # J.Parks: Assertion bug
            ...
            for argname, argtype, direction in self.methodInfo['args'] :
                ...
                # Input
                    ...
                    if not self.apiClassName == 'MTransformationMatrix': # J.Parks: Assertion bug
                ...
                # Output
                    ...
                    if not argtype == 'MString': # J.Parks: Assertion bug
...
class VirtualClassManager(object):
    ...
    def register( self, vclass, nameRequired=False, isVirtual='_isVirtual',
        ...
        """
        validSpecialAttrs = set(['__module__','__readonly__','__slots__','__melnode__','__doc__', '__apicls__']) # J.Parks: Added __apicls__ for Virtiaul Nodes
