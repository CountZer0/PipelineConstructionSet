...
def offsetCurveOnSurface(*args, **kwargs):
    ...
    Flags:
      ...
      - range : rn                     (bool)          [create]
          Force a curve range on complete input curveFlag can appear in Create mode of commandFlag can have multiple arguments,
...
def polyEditEdgeFlow(*args, **kwargs):
    ...
    Flags:
      - adjustEdgeFlow : aef           (float)         [create]
          The weight value of the edge vertices to be positioned.0: Concave0: Middle point1: Surface continuity1: ConvexDefault is
          1.0
      ...
      - nodeState : nds                (int)           [create,query,edit]
          ...
          Blocking state when enabledFlag can appear in Create mode of commandFlag can have multiple arguments, passed either as a
          tuple or a list.
...
def cone(*args, **kwargs):
    ...
    Flags:
      ...
      - polygon : po                   (int)           [create]
          ...
          for the conversion)Flag can appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple
          or a list.
...
def polySubdivideFacet(*args, **kwargs):
    ...
    Flags:
      ...
      - mode : m                       (int)           [create,query,edit]
          The subdivision mode.0: subdivision into quads1: subdivision into trianglesC: Default is 0.Q: When queried, this flag
          returns an int.Common flags
...
def attachCurve(*args, **kwargs):
    ...
    Flags:
      - blendBias : bb                 (float)         [create,query,edit]
          Skew the result toward the first or the second curve depending on the blend factory being smaller or larger than
          0.5.Default:0.5
      ...
      - replaceOriginal : rpo          (bool)          [create]
          Create "in place" (i.e., replace)Flag can appear in Create mode of commandFlag can have multiple arguments, passed
      ...
      - reverse1 : rv1                 (bool)          [create,query,edit]
          ...
          attaching. NOTE: setting this attribute to random values will cause unpredictable results and is not
...
def polyAppend(*args, **kwargs):
    ...
    Flags:
      - append : a                     (float, float, float) [create]
          ...
          space. Pass no arguments indicates that the values which follow shall specify a hole. In Python, pass an empty tuple to
          specify no arguments.Common flags
    
      - constructionHistory : ch       (bool)          [create,query]
          Turn the construction history on or off (where applicable). If construction history is on then the corresponding node
          will be inserted into the history chain for the mesh. If construction history is off then the operation will be
          performed directly on the object.Note:If the object already has construction history then this flag is ignored and the
          node will always be inserted into the history chain.Flag can appear in Create mode of commandFlag can have multiple
      ...
      - edge : ed                      (int)           [create]
          ...
          this flag should be avoided in Python. You may use the "append" flag instead and pass one argument.
    
      - hole : hl                      (bool)          [create]
          Add a hole. The following points and edges will define a hole. Note that this flag should be avoided in Python. You may
          use the "append" flag instead and pass an empty tuple ().
      ...
      - point : p                      (float, float, float) [create]
          ...
          flag should be avoided in Python. You may use the "append" flag instead and pass three arguments.
      ...
      - texture : tx                   (int)           [create,query,edit]
          Specifies how new faces are mapped.0 - None; 1 - Normalize; 2 - UnitizeC: Default is 0 (no mapping).Q: When queried,
...
def constructionHistory(*args, **kwargs):
    ...
    Flags:
      - toggle : tgl                   (bool)          [create,query]
          Turns construction history on or off.Flag can appear in Create mode of commandFlag can have multiple arguments, passed
          either as a tuple or a list.
...
def subdMirror(*args, **kwargs):
    ...
    Flags:
      ...
      - object : o                     (bool)          [create]
          Create the result, or just the dep. node (where applicable)Flag can appear in Create mode of commandFlag can have
...
def revolve(*args, **kwargs):
    ...
    Flags:
      ...
      - bridge : br                    (bool)          [create,query,edit]
          ...
          way it is in the full revolve case.Default:falseAdvanced flags
      ...
      - computePivotAndAxis : cpa      (int)           [create,query,edit]
          ...
          internally. The value of the pivot and axis attributes are ignored. If this is set to 1, we will take the supplied axis,
          but compute the pivot. If this is set to 0, we will take both the supplied axis and pivot.Default:0
      ...
      - useLocalPivot : ulp            (bool)          [create,query,edit]
          If true, then the pivot of the profile curve is used as the start point of the axis of revolution.Flag can appear in
...
def polyExtrudeEdge(*args, **kwargs):
    ...
    Flags:
      ...
      - inputCurve : inc               (PyNode)        [create]
          This flag specifies the name of the curve to be used as input for extrusionC: The selected edges will be extruded along
      ...
      - localRotateX : lrx             (float)         [create,query,edit]
          This flag specifies local rotation X angle (Slant Rot around slantAxis).C: Default is 0.0. The range is [0, 360].Q: When
      ...
      - localScaleZ : lsz              (float)         [create,query,edit]
          This flag specifies Z for local scaling vector : Flattening.C: Default is 1.0. The range is [0.0, 1.0].Q: When queried,
      ...
      - worldSpace : ws                (bool)          [create,query,edit]
          This flag specifies which reference to use. If "on" : all geometrical values are taken in world reference. If "off" :
          all geometrical values are taken in object reference.C: Default is off.Q: When queried, this flag returns an int.
...
def textCurves(*args, **kwargs):
    ...
    Flags:
      ...
      - name : n                       (unicode)       [create]
          Sets the name of the newly-created node. If it contains namespace path, the new node will be created under the specified
          namespace; if the namespace does not exist, it will be created.Flag can appear in Create mode of commandFlag can have
          multiple arguments, passed either as a tuple or a list.
...
def alignSurface(*args, **kwargs):
    ...
    Flags:
      ...
      - positionalContinuityType : pct (int)           [create,query,edit]
          ...
          modify first surface, 5 - modify second surface, 6 - modify both surfacesDefault:1
...
def nurbsUVSet(*args, **kwargs):
    ...
    Flags:
      ...
      - useExplicit : ue               (bool)          [create,query,edit]
          ...
          UVs.Flag can appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def polyColorPerVertex(*args, **kwargs):
    ...
    Flags:
      ...
      - representation : rpt           (int)           [create,query,edit]
          This flag corresponds to the color channels to used, for example A(alpha only), RGB, and RGBA.Flag can appear in Create
...
def doubleProfileBirailSurface(*args, **kwargs):
    """
    The arguments are 4 cuves called "profile1" "profile2" "rail1" "rail2". This command builds a railed surface by sweeping
    profile "profile1" along the two given rail curves "rail1", "rail2" until "profile2" is reached. By using the -blend
    control, the railed surface creation could be biased more towards one of the two profile curves. The curves ( both
    profiles and rails ) could also be surface curves ( isoparams, curve on surfaces ). If the profile curves are surface
    curves the surface constructed could be made tangent continuous to the surfaces underlying the profiles using the flags
    -tp1, -tp2 respectively. Current Limitation: Its necessary that the two profile curves intersect the rail curves for
    successful surface creation.
    
    Flags:
      - blendFactor : bl               (float)         [create,query,edit]
          A blend factor applied in between the two profiles. The amount of influence 'inputProfile1' has in the surface
          creation.Default:0.5
      ...
      - transformMode : tm             (int)           [create,query,edit]
          transform mode ( Non proportional, proportional ). Non proportional is default value.Default:0Advanced flags
...
def projectTangent(*args, **kwargs):
    ...
    Flags:
      ...
      - ignoreEdges : ie               (bool)          [create,query,edit]
          ...
          underlying surface in the U/V directions.Default:falseAdvanced flags
...
def polyColorBlindData(*args, **kwargs):
    ...
    Flags:
      ...
      - mode : m                       (int)           [create]
          ...
          color, and above max color are given. Data is colored according to how it relates to these values.7 : as color mode - if
          the blind data consists of 3 doubles, ranged 0-1, the components are colored as the data specifies
      ...
      - useMax : umx                   (bool)          [create]
          Specifies whether the max should be used for discrete rangesFlag can appear in Create mode of commandFlag can have
          multiple arguments, passed either as a tuple or a list.
...
def geomToBBox(*args, **kwargs):
    ...
    Flags:
      ...
      - startTime : st                 (time)          [create]
          Used with bakeAnimation flag. Specifies the start time of the baking process.Flag can appear in Create mode of
...
def uvSnapshot(*args, **kwargs):
    ...
    Flags:
      ...
      - fileFormat : ff                (unicode)       [create]
          Output file format. Any of those keyword: "iff", "sgi", "pic", "tif", "als", "gif", "rla", "jpg" Default is iff.Flag can
      ...
      - uMax : umx                     (float)         [create]
          Optional User Specified Max value for U. Default value is 1. This will take precedence over the "entire range" -euv
          flag.
    
      - uMin : umn                     (float)         [create]
          Optional User Specified Min value for U. Default value is 0. This will take precedence over the "entire range" -euv
          flag.
      ...
      - vMax : vmx                     (float)         [create]
          Optional User Specified Max value for V. Default value is 1. This will take precedence over the "entire range" -euv
          flag.
    
      - vMin : vmn                     (float)         [create]
          Optional User Specified Min value for V. Default value is 0. This will take precedence over the "entire range" -euv
          flag.
...
def addMetadata(*args, **kwargs):
    ...
    these flags - channelNameis the metadata channel type (e.g. "vertex"), streamNameis the name of the metadata stream to
    be created, and structureis the name of the structure type defining the contents of the metadata. The indexTypeflag is
    ...
    Flags:
      ...
      - indexType : idt                (unicode)       [create,query]
          ...
          native types only a mesh "vertexFace" channel is different, using a "pair" index type. In query mode, this flag can
          accept a value.
      ...
      - structure : str                (unicode)       [create,query]
          ...
          of the structure attached at a given stream. In query mode, this flag can accept a value.Flag can appear in Create mode
...
def polyCone(*args, **kwargs):
    ...
    Flags:
      ...
      - createUVs : cuv                (int)           [create]
          ...
          whole without any normalization.The cone will be unwrapped and then the texture will be appliedwithout any distortion.In
          the unwrapped cone, the shared edges will have shared UVs.2 implies the UVs should be normalized. This will normalize
          theU and V direction separately, thereby resulting in distortion of textures.4 implies UVs are created so that the
          texture will not be distorted when applied.The texture lying outside the UV range will be truncated (since that cannot
          besqueezed in, without distorting the texture.For better understanding of these options, you may have to open thetexture
          view windowC: Default is 3
      ...
      - texture : tx                   (bool)          [create]
          This flag is obsolete and will be removed in the next release. The -cuv/createUVs flag should be used instead.Common
          flags
...
def polyOptions(*args, **kwargs):
    ...
    Flags:
      ...
      - colorMaterialChannel : cm      (unicode)       [create,query]
          ...
          "none" : disable material shading"ambient" : ambient material channel"ambientDiffuse" : ambient and diffuse material
          channel"diffuse" : diffuse material channel"specular" : specular material channel"emission" : emission material channel
      ...
      - vertexNormalMethod : vnm       (int)           [create,query]
          ...
          attribute on a polymesh object. Options are: 0: Unweighted 1: Angle Weighted 2: Area Weighted 3: Angle And Area
          WeightedFlag can appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def detachSurface(*args, **kwargs):
    """
    The detachSurface command detaches a surface into pieces, given a list of parameter values and a direction. You can also
    specify which pieces to keep and which to discard using the "-k" flag. The names of the newly detached surface(s) are
    ...
    parameter value. You would use this command with only one "-p" flag. If you are specifying "-k" flags, then you must
    specify one, none or all "-k" flags. If you are specifying all "-k" flags, there must be one more "-k" flag than "-p"
    flags.
...
def untangleUV(*args, **kwargs):
    ...
    Flags:
      - mapBorder : mb                 (unicode)       [create]
          ...
          square with picked UV at (0,0)shape- a mapping which attempts to reflect the actual shape of the object where the picked
          UV is placed on the line from (0,0) -(0.5,0.5)shape_circular- shape mapping which will interpolate to a circular mapping
          just enough to prevent self-intersections of the mapped bordershape_square- shape mapping which will interpolate to a
          square mapping just enough to prevent self-intersections of the mapped border
      ...
      - pinUnselected : pu             (bool)          [create]
          If this is true, then all unselected UVs in each mesh are pinned in place during any relaxationFlag can appear in Create
          mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def polyPyramid(*args, **kwargs):
    ...
    Flags:
      ...
      - createUVs : cuv                (int)           [create]
          This flag alows a specific UV mechanism to be selected, while creating the primitive.The valid values are 0, 1, 2 or 3.0
          implies that no UVs will be generated (No texture to be applied).1 implies UVs should be created for the object as a
          whole without any normalization.The primitive will be unwrapped and then the texture will be appliedwithout any
          distortion.In the unwrapped primitive, the shared edges will have shared UVs.2 implies the UVs should be normalized.
          This will normalize theU and V direction separately, thereby resulting in distortion of textures.4 implies UVs are
          created so that the texture will not be distorted when applied.The texture lying outside the UV range will be truncated
          (since that cannot besqueezed in, without distorting the texture.For better understanding of these options, you may have
          to open thetexture view windowC: Default is 3
      ...
      - subdivisionsCaps : sc          (int)           [create,query,edit]
          This flag specifies the number of subdivisions on bottom cap for the pyramid.C: Default is 0.Q: When queried, this flag
          returns an int.
...
def filterExpand(*args, **kwargs):
    ...
    Object TypeMaskHandle0Nurbs Curves9Nurbs Surfaces10Nurbs Curves On Surface11Polygon12Locator XYZ22Orientation
    Locator23Locator UV24Control Vertices (CVs)28Edit Points30Polygon Vertices31Polygon Edges32Polygon Face34Polygon
    UVs35Subdivision Mesh Points36Subdivision Mesh Edges37Subdivision Mesh Faces38Curve Parameter Points39Curve
    Knot40Surface Parameter Points41Surface Knot42Surface Range43Trim Surface Edge44Surface Isoparms45Lattice
    Points46Particles47Scale Pivots49Rotate Pivots50Select Handles51Subdivision Surface68Polygon Vertex Face70NURBS Surface
    Face72Subdivision Mesh UVs73
    ...
    Flags:
      ...
      - fullPath : fp                  (bool)          [create]
          ...
          object only when this value is false. Default is false.Flag can appear in Create mode of commandFlag can have multiple
          arguments, passed either as a tuple or a list.
...
def polyExtrudeFacet(*args, **kwargs):
    ...
    Flags:
      - attraction : att               (float)         [create,query,edit]
          This flag specifies the attraction, related to magnet.C: Default is 0.0. The range is [-2.0, 2.0].Q: When queried, this
      ...
      - inputCurve : inc               (PyNode)        [create]
          This flag specifies the name of the curve to be used as input for extrusionC: The selected faces will be extruded along
          the curve. It will be useful to set a higher value (greater than 4) for the '-d/-divisions' flag, to get good results.
          The normal of the surface has to be aligned with the direction of the curve. The extrusion is evenly distributed in the
          curve's parameter space, and not on the curve's geometry space
      ...
      - localScaleZ : lsz              (float)         [create,query,edit]
          This flag specifies Z for local scaling vector : Flattening.C: Default is 1.0. The range is [0.0, 1.0].Q: When queried,
          this flag returns a float. Dynamic Values
...
def nurbsToPolygonsPref(*args, **kwargs):
    ...
    menu items and is saved between Maya sessions. To query any of the flags, use the "-query" flag. For more information on
    the flags, see the node documentation for the "nurbsTessellate" node. In query mode, return type is based on queried
    flag.
...
def pointOnCurve(*args, **kwargs):
    ...
    Flags:
      ...
      - constructionHistory : ch       (bool)          [create]
          Turn the construction history on or offFlag can appear in Create mode of commandFlag can have multiple arguments, passed
          either as a tuple or a list.
...
def polyFlipUV(*args, **kwargs):
    ...
    Flags:
      ...
      - insertBeforeDeformers : ibd    (bool)          [create]
          ...
          shape. Inserting the node after the deformer leads to texture swimming during animation and is most often undesirable.C:
          Default is on.
...
def propMove(*args, **kwargs):
    ...
    Flags:
      - percent : p                    (float)         [create]
          ...
          if there are 4 objects specified, there must be 4 "-p" flags, (otherwise a percentage of 1.0 will be used). This flag
      ...
      - pivot : pi                     (float, float, float) [create]
          ...
          'propMove' command, and so must be used in conjunction with one of the above move flags for any effect to be
          noticeable.Flag can appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple or a
          list.
      ...
      - rotate : r                     (float, float, float) [create]
          ...
          that object's corresponding "-percent" flag. All angles are in degrees. The rotation is about the pivot specified by the
          "-pivot" flag, or (0, 0, 0) if the "-pivot" flag is not present.
      ...
      - scale : s                      (float, float, float) [create]
          ...
          object's corresponding "-percent" flag. The position and size of each object is measured relative to the pivot specified
          by the "-pivot" flag, and defaults to each object's individual pivot. In the case of control vertices, or some other
          object component, the default is the parent object's pivot.
      ...
      - translate : t                  (float, float, float) [create]
          ...
          by that object's corresponding "-percent" flag. The "-pivot" flag has no effect on translation.
...
def subdivCrease(*args, **kwargs):
    ...
    Flags:
      - sharpness : sh                 (bool)          [create]
          Specifies the sharpness value to set the crease toFlag can appear in Create mode of commandFlag can have multiple
          arguments, passed either as a tuple or a list.
...
def multiProfileBirailSurface(*args, **kwargs):
    ...
    arguments. For examples, if 5 curves are specified, they will correspond to "curve1" "curve2" "curve3" "rail1" "rail2".
    In this case, the cmd creates a railed surface by sweeping the profile "curve1" to profile "curve2", profile "curve2" to
    profile "curve3" along the two rail curves "rail1", "rail2". There must be atleast 3 profile curves followed by the two
    rail curves. The profile curves must intersect the two rail curves. The constructed may be made tangent continuous to
    the first and last profile using the flags -tp1, -tp2 provided the profiles are surface curves i.e. isoparms, curve on
...
def bezierInfo(*args, **kwargs):
    ...
    Flags:
      ...
      - onlyTangentsSelected : ots     (bool)          [create]
          Returns 1 if the only CV components selected are tangent CVs. 0, otherwise.Flag can appear in Create mode of commandFlag
...
def polyCut(*args, **kwargs):
    ...
    adjusted using the appropriate flags listed above. In addition, the cut operation can also delete the faces lying on one
    ...
    Flags:
      ...
      - cuttingDirection : cd          (unicode)       [create]
          This flag specifies the direction of the cutting plane. Valid values are "x", "y", "z" A value of "x" will cut the
          object along the YZ plane cutting through the center of the bounding box. A value of "y" will cut the object along the
          ZX plane cutting through the center of the bounding box. A value of "z" will cut the object along the XY plane cutting
      ...
      - extractOffset : eo             (float, float, float) [create]
          This flag specifies the offset by which the cut faces will be extracted. This flag has no effect when the "extractFaces"
          is turned off.
...
def polyHelix(*args, **kwargs):
    ...
    Flags:
      ...
      - createUVs : cuv                (int)           [create]
          ...
          implies that no UVs will be generated (No texture to be applied).1 implies UVs should be created for the object as a
          whole without any normalization.The helix will be unwrapped and then the texture will be appliedwithout any
          distortion.In the unwrapped helix, the shared edges will have shared UVs.2 implies the UVs should be normalized. This
          will normalize theU and V direction separately, thereby resulting in distortion of textures.4 implies UVs are created so
          that the texture will not be distorted when applied.The texture lying outside the UV range will be truncated (since that
          cannot besqueezed in, without distorting the texture.For better understanding of these options, you may have to open
          thetexture view windowC: Default is 3
...
def subdToPoly(*args, **kwargs):
    ...
    Flags:
      ...
      - applyMatrixToResult : amr      (bool)          [create,query,edit]
          ...
          matrix on it.Default:trueAdvanced flags
    
      - caching : cch                  (bool)          [create,query,edit]
          Modifies the node caching mode. See the node documentation for more information.Note:For advanced users only.
    
      - connectShaders : cs            (bool)          [create]
          If true, all shader assignment will be copied from the original subdiv surface to the converted polygonal
          surface.Default:trueFlag can appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple
          or a list.
      ...
      - copyUVTopology : cut           (bool)          [create,query,edit]
          Copy over uv topology (shared/unshared) from the original subdivision surface to the converted polygonal
          mesh.Default:false
    
      - depth : d                      (int)           [create,query,edit]
          The depth at which constant-depth tessellates the surfaceDefault:0
      ...
      - sampleCount : sc               (int)           [create,query,edit]
          The number of samples per faceDefault:1
      ...
      - subdNormals : un               (bool)          [create,query,edit]
          Keep subdiv surface normalsDefault:false
...
def polyReduce(*args, **kwargs):
    ...
    Flags:
      ...
      - compactness : com              (float)         [create,query,edit]
          ...
          computationQ: When queried, this flag returns a float.
      ...
      - keepBorderWeight : kbw         (float)         [create,query,edit]
          ...
          This flag only applies when using the new algorithm. (-version 1)C: Default is 0.5.Q: When queried, this flag returns a
          float.
    
      - keepColorBorder : kcb          (bool)          [create,query,edit]
          If true, reduction will try to retain color borders. These are determined according to color Ids. This flag only applies
          when using the new algorithm. (-version 1)C: Default is true.Q: When queried, this flag returns a boolean.
      ...
      - keepFaceGroupBorder : kfb      (bool)          [create,query,edit]
          If true, reduction will try to retain borders of face groups, which are mostly used to define material assignments. This
          flag only applies when using the new algorithm. (-version 1)C: Default is true.Q: When queried, this flag returns a
          boolean.
    
      - keepFaceGroupBorderWeight : kfw (float)         [create,query,edit]
          If keepFaceGroupBorder is on, this flag specifies the weight to assign to material borders. Setting this value to 0 will
          disable group border preservation and a value of 1 will exactly preserve all group borders. This flag only applies when
          using the new algorithm. (-version 1)C: Default is 0.5.Q: When queried, this flag returns a float.
      ...
      - keepHardEdgeWeight : khw       (float)         [create,query,edit]
          If keepHardEdge is on, this flag specifies the weight to assign to hard edges. Setting this value to 0 will disable hard
          edge preservation and a value of 1 will exactly preserve all hard edges. This flag only applies when using the new
      ...
      - keepMapBorderWeight : kmw      (float)         [create,query,edit]
          If keepMapBorder is on, this flag specifies the weight to assign to UV map borders. Setting this value to 0 will disable
          UV map border preservation and a value of 1 will exactly preserve all UV borders. This flag only applies when using the
          new algorithm. (-version 1)C: Default is 0.5.Q: When queried, this flag returns a float.
      ...
      - keepOriginalVertices : kev     (bool)          [create,query,edit]
          ...
          vertices always retain their exact original positions. (though the Ids will change)C: Default is false.Q: When queried,
      ...
      - preserveTopology : top         (bool)          [create,query,edit]
          ...
          only applies when using the new algorithm. (-version 1)C: Default is true.Q: When queried, this flag returns a boolean.
    
      - replaceOriginal : rpo          (bool)          [create]
          Create "in place" (i.e., replace) (not available in all commands). NOTE: This flag is intended for use by the "Reduce"
          menu item. If 'polyReduce -rpo 0' is executed from the command line, Shader information will not be copied from the
          original mesh to the result.
    
      - sharpness : shp                (float)         [create,query,edit]
          Sharpness controls the balance between preserving small, sharp details versus larger shapes. At low values, details that
          are small relative to the general shape of the object are more likely to be collapsed. At high values, they are more
          likely to be kept. This flag only applies when using the new algorithm. (-version 1)C: Default is 0.Q: When queried,
          this flag returns a float.
      ...
      - symmetryTolerance : stl        (float)         [create,query,edit]
          ...
          symmetries, lower values might miss symmetries. The value is distance in object space. This flag only applies when using
          the new algorithm (-version 1) and the useVirtualSymmetry flag is not set to 0.C: Default is 0.Q: When queried, this
          flag returns a float.
      ...
      - termination : trm              (int)           [create,query,edit]
          ...
          algorithm. (-version 1)0 Percentage1 Vertex count2 Triangle countC: Default is 0.Q: When queried, this flag returns an
          integer.
      ...
      - triangleCount : tct            (int)           [create,query,edit]
          ...
          applies when using the new algorithm (-version 1) and the termination flag is set to 2.C: Default is 0.Q: When queried,
          this flag returns an integer.
      ...
      - triangulate : t                (bool)          [create,query,edit]
          ...
          specifies if the geometry or the selected faces has to be triangulated, before performing reduction.C: Default is
          true.Q: When queried, this flag returns a boolean.Common flags
      ...
      - useVirtualSymmetry : uvs       (int)           [create,query,edit]
          ...
          algorithm (-version 1) and the keepQuadsWeight flag is less than 1.0.0 No symmetry preservation1 Automatic. Try to find
          suitable symmetry during reduction.2 Plane. Specify a symmetry plane to use during reduction.C: Default is 0.Q: When
      ...
      - version : ver                  (int)           [create,query,edit]
          Version of the poly reduce algorithm to use.0 Old algorithm used in Maya 2013 and prior for backwards compatibility1 New
          algorithm derived from Softimage and used in Maya 2014 and laterThe default is 0 for backwards compatibility but for
          best results it is recommended that the new algorithm is used as it is better at preserving mesh details. Some flags
      ...
      - vertexCount : vct              (int)           [create,query,edit]
          ...
          applies when using the new algorithm (-version 1) and the termination flag is set to 1.C: Default is 0.Q: When queried,
          this flag returns an integer.
...
def insertKnotSurface(*args, **kwargs):
    ...
    specify one, none or all number of knots with the "-nk" flag. eg. if you specify none, then the default (one) knot will
    be added at each specified parameter value. If you specify one "-nk" value then that number of knots will be added at
    each parameter value. Otherwise, you must specify the same number of "-nk" flags as "-p" flags, defining the number of
    knots to be added at each specified parameter value. You can insert up to "degree" knots at a parameter value that isn't
    already an isoparm. eg. for a degree 3 surface, you can insert up to 3 knots. Use this operation if you need more CVs in
    a local area of the surface. Use this operation if you want to create a corner in the surface. Note: A single
    insertKnotSurface command cannot insert in both directions at once; you must use two separate commands to do this.
    
    Flags:
      - addKnots : add                 (bool)          [create,query,edit]
          Whether to add knots or complement. Complement means knots will be added to reach the specified number of
          knots.Default:true
...
def polyOutput(*args, **kwargs):
    ...
    Flags:
      ...
      - noOutput : no                  (bool)          [create]
          Dont output any data. Would be useful if you want to just evaluate the data, for testing purposes.Flag can appear in
          Create mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def polyOptUvs(*args, **kwargs):
    ...
    Flags:
      ...
      - globalMethodBlend : gmb        (float)         [create]
          The global optimization method uses two functions to compute a minimization. The first function controls edge stretch by
          using edges lengths between xyz and uv. The second function penalizes the first function by preventing configurations
          where triangles would overlap. For every surface there is a mix between these two functions that will give the
          appropriate response. Values closer to 1.0 give more weight to the edge length function. Values closer to 0.0 give more
          weight to surface area. The default value of '0.5' is a even mix between these two values.
...
def subdAutoProjection(*args, **kwargs):
    ...
    Flags:
      ...
      - constructionHistory : ch       (bool)          [create,query]
          Turn the construction history on or off (where applicable).Flag can appear in Create mode of commandFlag can have
          multiple arguments, passed either as a tuple or a list.
      ...
      - optimize : o                   (int)           [create,query,edit]
          ...
          distortion.1 Small UV pieces are incorporated into larger ones, when the extra distortion introduced is reasonable. This
          tends to produce fewer UV pieces.
      ...
      - worldSpace : ws                (bool)          [create,query,edit]
          This flag specifies which reference to use. If "on" : all geometrical values are taken in world reference. If "off" :
          all geometrical values are taken in object reference.C: Default is "off".Common flags
...
def polyColorSet(*args, **kwargs):
    """
    Command to do the following to color sets: - delete an existing color set. - rename an existing color set. - create a
    new empty color set. - set the current color set to a pre-existing color set. - modify sharing between instances of per-
    instance color sets - query the current color set. - query the names of all color sets. - query the name(s) along with
    representation value(s) or clamped value(s) of all color sets - query the representation value or clamped value of the
    current color set
    ...
    Flags:
      ...
      - currentPerInstanceSet : cpi    (bool)          [query,edit]
          ...
          of the set family that corresponds to the currently select instance.Flag can appear in Create mode of commandFlag can
...
def polyCacheMonitor(*args, **kwargs):
    ...
    Flags:
      - cacheValue : chv               (bool)          [create]
          ...
          false decrements the counter.Flag can appear in Create mode of commandFlag can have multiple arguments, passed either as
          a tuple or a list.
...
def curve(*args, **kwargs):
    ...
    either with weights or without. You can replace an existing curve by using the "-r/replace" flag. You can append a point
    to an existing curve by using the "-a/append" flag. To create a curve-on-surface, use the curveOnSurface command. To
    change the degree of a curve, use the rebuildCurve command. To change the of parameter range curve, use the rebuildCurve
    command.
    ...
    Flags:
      ...
      - editPoint : ep                 (float, float, float) [create]
          The x, y, z position of an edit point. "linear" means that this flag can take values with units. This flag can not be
      ...
      - objectSpace : os               (bool)          [create]
          Points are in object, or "local" space. This is the default. You cannot specify both "-os" and "-ws" in the same
          command.
      ...
      - worldSpace : ws                (bool)          [create]
          Points are in world space. The default is "-os". You cannot specify both "-os" and "-ws" in the same command.Flag can
          appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def nurbsToSubdivPref(*args, **kwargs):
    ...
    creation commands and is saved between Maya sessions. To query any of the flags, use the "-query" flag. For more
    information on the flags, see the node documentation for the "nurbsToSubdivProc" node. In query mode, return type is
...
def loft(*args, **kwargs):
    ...
    Flags:
      ...
      - createCusp : cc                (bool)          [create,query,edit]
          ...
          particular profile will have a cusp (tangent break) in the resulting surface.Default:falseAdvanced flags
      ...
      - rebuild : rb                   (bool)          [create]
          Rebuild the input curve(s) before using them in the operation. Use nurbsCurveRebuildPref to set the parameters for the
          conversion.Flag can appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple or a
          list.
...
def nurbsCube(*args, **kwargs):
    ...
    Flags:
      ...
      - patchesU : u                   (int)           [create,query,edit]
          Number of sections in UDefault:1
    
      - patchesV : v                   (int)           [create,query,edit]
          Number of sections in VDefault:1
      ...
      - width : w                      (float)         [create,query,edit]
          Width of the objectDefault:1.0
...
def subdListComponentConversion(*args, **kwargs):
    ...
    the list of the conversion. It doesn't change the currently selected objects. Use the "-in/internal" flag to specify
    conversion to "connected" vs. "contained" components. For example, if the internal flag is specified when converting
    from subdivision surface vertices to faces, then only faces that are entirely contained by the vertices will be
    returned. If the internal flag is not specified, then all faces that are connected to the vertices will be returned.
    ...
    Flags:
      ...
      - internal : internal            (bool)          [create]
          Applicable when converting from "smaller" component types to larger ones. Specifies conversion to "connected" vs.
          "contained" components. See examples below.Flag can appear in Create mode of commandFlag can have multiple arguments,
          passed either as a tuple or a list.
...
def polySplitRing(*args, **kwargs):
    ...
    Flags:
      ...
      - divisions : div                (int)           [create]
          If the splitType is set to 2 then this is used to control how many new edge loops are inserted. This number has to be at
          least 1.
      ...
      - smoothingAngle : sma           (float)         [create]
          Subdivide new edges will be soft if less then this angle.Default is 180.0Common flags
    
      - splitType : stp                (int)           [create]
          Choose between 3 different types of splits. If this is set to 0 then the split type will be absolute. This is where each
          of the splits will maintain an equal distance from the associated vertices. If this set to 1 then the split type will be
          relative. This is where each split will be made at an equal percentage along the length of the edge. If this is set to 2
          then the edge will be split one or more times. The number of times is controlled by the -div/-divisions flag. For an
          absolute or relative type of split the user can adjust the weight to position where the split occurrs. If the split is a
          multi split then the splits will be spaced out evenly.
...
def polyEditUVShell(*args, **kwargs):
    ...
    Flags:
      ...
      - uvSetName : uvs                (unicode)       [create,query]
          Specifies the name of the uv set to edit uvs on. If not specified will use the current uv set if it exists.Flag can
          appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def closeCurve(*args, **kwargs):
    ...
    Flags:
      - blendBias : bb                 (float)         [create,query,edit]
          Skew the result toward the first or the second curve depending on the blend value being smaller or larger than
          0.5.Default:0.5
      ...
      - curveOnSurface : cos           (bool)          [create]
          If possible, create 2D curve as a resultFlag can appear in Create mode of commandFlag can have multiple arguments,
          passed either as a tuple or a list.
...
def subdCollapse(*args, **kwargs):
    ...
    number of hierarchy levels "removed". Returns the name of the subdivision surface created and optionally the DG node
    ...
    Flags:
      ...
      - level : l                      (int)           [create,query,edit]
          The level which will now become the base meshDefault:0Advanced flags
...
def polySelectConstraintMonitor(*args, **kwargs):
    ...
    Flags:
      ...
      - delete : d                     (bool)          [create]
          Specifies that the Monitor should be removedFlag can appear in Create mode of commandFlag can have multiple arguments,
          passed either as a tuple or a list.
...
def polyPlanarProjection(*args, **kwargs):
    ...
    Flags:
      ...
      - createNewMap : cm              (bool)          [create,query,edit]
          This flag when set true will create a new map with a the name passed in, if the map does not already exist.Common flags
      ...
      - imageCenterX : icx             (float)         [create,query,edit]
          This flag specifies X for the center point of the 2D model layout.C: Default is 0.5.Q: When queried, this flag returns a
          float.
    
      - imageCenterY : icy             (float)         [create,query,edit]
          This flag specifies Y for the center point of the 2D model layout.C: Default is 0.5.Q: When queried, this flag returns a
          float.
      ...
      - mapDirection : md              (unicode)       [create]
          ...
          along the current camera viewing direction.'p' does perspective projection if current camera is perspective.'b' projects
          along the best plane fitting the objects selected.
      ...
      - projectionCenterX : pcx        (float)         [create,query,edit]
          This flag specifies X for the origin point from which the map is projected.C: Default is 0.0.Q: When queried, this flag
          returns a float.
    
      - projectionCenterY : pcy        (float)         [create,query,edit]
          This flag specifies Y for the origin point from which the map is projected.C: Default is 0.0.Q: When queried, this flag
          returns a float.
    
      - projectionCenterZ : pcz        (float)         [create,query,edit]
          This flag specifies Z for the origin point from which the map is projected.C: Default is 0.0.Q: When queried, this flag
          returns a float.
      ...
      - projectionScale : ps           (float, float)  [create,query,edit]
          This flag specifies the width and the height of the map relative to the 3D projection axis.C: Default is 1.0 1.0.Q: When
          queried, this flag returns a float[2].
    
      - projectionScaleU : psu         (float)         [create,query,edit]
          This flag specifies the width of the map relative to the 3D projection axis.C: Default is 1.0.Q: When queried, this flag
          returns a float.
...
def circle(*args, **kwargs):
    ...
    Flags:
      ...
      - fixCenter : fc                 (bool)          [create,query,edit]
          ...
          point.Default:trueAdvanced flags
      ...
      - object : o                     (bool)          [create]
          Create the result, or just the dependency nodeFlag can appear in Create mode of commandFlag can have multiple arguments,
          passed either as a tuple or a list.
      ...
      - sweep : sw                     (float)         [create,query,edit]
          The sweep angle determines the completeness of the circle. A full circle is 2Pi radians, or 360
          degrees.Default:6.2831853
...
def makeSingleSurface(*args, **kwargs):
    ...
    Flags:
      ...
      - format : f                     (int)           [query,edit]
          Format: 0 - Triangle Count, 1 - Standard Fit, 2 - General, 3 - CVsDefault:1
      ...
      - polygonType : pt               (int)           [query,edit]
          Polygon type: 0 - Triangles, 1 - QuadsDefault:0
      ...
      - uType : ut                     (int)           [query,edit]
          ...
          parameter space. Type 2 - Per span # of isoparms. This type places a specific number of iso-parametric subdivision lines
          across each surface span, equally spaced in parameter space. (This is the closest option to the Alias Studio
      ...
      - vType : vt                     (int)           [query,edit]
          Initial V type tessellation criteria (3 types). See description for the uType attribute. Only used if Format is
          General.Default:3
...
def polyEvaluate(*args, **kwargs):
    ...
    Flags:
      ...
      - worldArea : wa                 (bool)          [create]
          returns the surface area of the object's faces in world space as a floatFlag can appear in Create mode of commandFlag
          can have multiple arguments, passed either as a tuple or a list.
...
def subdiv(*args, **kwargs):
    ...
    Flags:
      ...
      - proxyMode : pm                 (int)           [create,query]
          When queried, this flag returns an integer representing whether or not the subdivision surface is in "polygon proxy"
          mode. "Proxy" mode allows the base mesh of a subdivision surface without construction history to be edited using the
          polygonal editing tools. Returns 1, if the subdivision surface is in "polygon proxy" mode. Returns 0, if the surface is
          not currently in "proxy" mode, but could be put into "proxy" mode since it has no construction history. (This state is
          also known as "standard" mode.) Returns 2, if the surface is not in "proxy" mode and cannot be put into proxy mode, as
          it has construction history.Flag can appear in Create mode of commandFlag can have multiple arguments, passed either as
          a tuple or a list.
...
def bezierAnchorPreset(*args, **kwargs):
    ...
    Flags:
      - preset : p                     (int)           [create]
          Selects a preset to apply to selected Bezier anchors. Valid arguments are: 0: Bezier 1: Bezier Corner 2: CornerFlag can
          appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def setXformManip(*args, **kwargs):
    ...
    Flags:
      - showUnits : su                 (bool)          [query]
          If set to true, the xform manip displays current units; otherwise, the manip hides them.Flag can appear in Create mode
          of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def planarSrf(*args, **kwargs):
    ...
    Flags:
      ...
      - tolerance : tol                (float)         [create,query,edit]
          The distance tolerance for the cvs of the curves to be in the same plane.Default:0.01Advanced flags
...
def stitchSurfacePoints(*args, **kwargs):
    ...
    Flags:
      ...
      - cascade : c                    (bool)          [create]
          Cascade the created stitch node. (Only if the surface has a stitch history)Default is 'false'.Flag can appear in Create
          mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def transferAttributes(*args, **kwargs):
    ...
    Flags:
      ...
      - matchChoice : mch              (int)           [create,edit]
          ...
          user to explore the other matches.Flag can appear in Create mode of commandFlag can have multiple arguments, passed
          either as a tuple or a list.
      ...
      - transferPositions : pos        (int)           [create,edit]
          A non-zero value indicates vertex position should be sampled, causing the target surface to "wrap" to the source
          surface(s).
...
def polySelect(*args, **kwargs):
    ...
    Flags:
      ...
      - asSelectString : ass           (bool)          [create,query]
          Changes the return type from an integer array to a string array which can be used as a selection string.Flag can appear
...
def unfold(*args, **kwargs):
    ...
    Flags:
      ...
      - optimizeAxis : oa              (int)           [create]
          Degree of freedom for optimization 0=Optimize freely, 1=Move vertically only, 2=Move horzontally onlyFlag can appear in
          Create mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def polyCompare(*args, **kwargs):
    ...
    Flags:
      ...
      - userNormals : un               (bool)          [create]
          Compare poly1, poly2 for matching User Normals.Flag can appear in Create mode of commandFlag can have multiple
          arguments, passed either as a tuple or a list.
...
def polySubdivideEdge(*args, **kwargs):
    ...
    Flags:
      ...
      - worldSpace : ws                (bool)          [create,query,edit]
          This flag specifies which reference to use. If "on" : all geometrical values are taken in world reference. If "off" :
          all geometrical values are taken in object reference.C: Default is "off".Q: When queried, this flag returns an
          int.Common flags
...
def squareSurface(*args, **kwargs):
    ...
    Flags:
      ...
      - continuityType1 : ct1          (int)           [create,query,edit]
          Continuity type legal values for curve 1: 1 - fixed boundary 2 - tangent continuity 3 - implied tangent
          continuityDefault:2
    
      - continuityType2 : ct2          (int)           [create,query,edit]
          Continuity type legal values for curve 2: 1 - fixed boundary 2 - tangent continuity 3 - implied tangent
          continuityDefault:2
    
      - continuityType3 : ct3          (int)           [create,query,edit]
          Continuity type legal values for curve 3: 1 - fixed boundary 2 - tangent continuity 3 - implied tangent
          continuityDefault:2
    
      - continuityType4 : ct4          (int)           [create,query,edit]
          Continuity type legal values for curve 4: 1 - fixed boundary 2 - tangent continuity 3 - implied tangent
          continuityDefault:2
...
def blindDataType(*args, **kwargs):
    ...
    Flags:
      - dataType : dt                  (unicode)       [create]
          Specifies the dataTypes that are part of BlindData node being created. Allowable strings are "int", "float", "double",
          "string", "boolean" and "binary". Must be used togeter with the -ldn and -sdn flags to specify each attribute.
      ...
      - shortDataName : sdn            (unicode)       [create]
          ...
          and -ldn flags to specify each attribute.Flag can appear in Create mode of commandFlag can have multiple arguments,
          passed either as a tuple or a list.
...
def insertKnotCurve(*args, **kwargs):
    ...
    knot is inserted. You can insert up to "degree" knots at a curve parameter that isn't already an edit point. eg. for a
    ...
    Flags:
      ...
      - insertBetween : ib             (bool)          [create,query,edit]
          If set to true, and there is more than one parameter value specified, the knots will get inserted at equally spaced
          intervals between the given parameter values, rather than at the parameter values themselves.Default:falseAdvanced flags
...
def polyMoveFacet(*args, **kwargs):
    ...
    Flags:
      ...
      - pivotZ : pvz                   (float)         [create,query,edit]
          This flag specifies the Z pivot for scaling and rotation.C: Default is 0.0.Q: When queried, this flag returns a
          float.Local Values
...
def extrude(*args, **kwargs):
    ...
    profile curve. The most basic method is called a "distance" extrude where direction and length are specified. No path
    curve is necessary in this case. The second method is called "flat" extrude. This method sweeps the profile curve down
    the path curve without changing the orientation of the profile curve. Finally, the third method is called "tube"
    extrude. This method sweeps a profile curve down a path curve while the profile curve rotates so that it maintains a
    relationship with the path curve.
    ...
    Flags:
      ...
      - subCurveSubSurface : scs       (bool)          [create,query,edit]
          If true, curve range on the path will get applied to the resulting surface instead of cut before the
          extrude.Default:falseAdvanced flags
      ...
      - useProfileNormal : upn         (bool)          [create,query,edit]
          If true, use the profile curve normal for the direction in which to extrude. Use only for distance or tube
          extrudeType.Default:false
...
def moveVertexAlongDirection(*args, **kwargs):
    ...
    movement could also be either in tangent along U or tangent along V. The flags -n, -u, -v and -d are mutually exclusive,
    ie. the selected vertices can be all moved in only -n or -u or -v or -d.
    ...
    Flags:
      ...
      - magnitude : m                  (float)         [create]
          move by the specified magnitude in the direction vector.Flag can appear in Create mode of commandFlag can have multiple
          arguments, passed either as a tuple or a list.
...
def polyCube(*args, **kwargs):
    ...
    Flags:
      ...
      - createUVs : cuv                (int)           [create]
          This flag alows a specific UV mechanism to be selected, while creating the cube.The valid values are 0, 1, 2 ,3 or 4.0
          implies that no UVs will be generated (No texture to be applied).1 implies UVs should be created for the object as a
          whole without any normalization.The cube will be unwrapped and then the texture will be appliedwithout any distortion.In
          the unwrapped cube, the shared edges will have shared UVs.2 implies UVs are created separately for each of the faces of
          the cube.3 implies the UVs should be normalized. This will normalize theU and V direction separately, thereby resulting
          in distortion of textures.4 implies UVs are created so that the texture will not be distorted when applied.The texture
          lying outside the UV range will be truncated (since that cannot besqueezed in, without distorting the texture.For better
          understanding of these options, you may have to open thetexture view windowC: Default is 4
...
def polyProjection(*args, **kwargs):
    """
    Creates a mapping on the selected polygonal faces. When construction history is created, the name of the new node is
    returned. In other cases, the command returns nothing.
    ...
    Flags:
      ...
      - createNewMap : cm              (bool)          [create]
          Create new map if does not existsFlag can appear in Create mode of commandFlag can have multiple arguments, passed
          either as a tuple or a list.
      ...
      - insertBeforeDeformers : ibd    (bool)          [create]
          ...
          Inserting the projection after the deformer leads to texture swimming during animation and is most often undesirable.
          Default is on.
    
      - keepImageRatio : kir           (bool)          [create]
          Specifies if the xy scaling in the planar projection has to be uniform. By setting this flag, the texture aspect ratio
          is preserved. This flag is ignored for cylindrical and spherical projections.
    
      - mapDirection : md              (unicode)       [create]
          Specifies the direction of the projection. By specifying this flag, the projection placement values (pcx, pcy, pcz, rx,
          ry, rz, psu, psv) are internally computed. If both this flag and the projection values are specified, the projection
          values are ignored Valid Values are : X Projects along the X Axis Y Projects along the Y Axis Z Projects along the Z
          Axis bestPlane Projects on the best plane fitting the object camera Projects along the viewing direction perspective
          Creates perspective projection if current camera is perspective Default is bestPlane
      ...
      - seamCorrect : sc               (bool)          [create]
          Specifies if seam correction has to be done for spherical and cylindrical projections. This flag is ignored, if the
      ...
      - smartFit : sf                  (bool)          [create]
          ...
          projections. For smart fitting the planar projection, the mapDirection flag has to be used, since there are several
          options for smart fitting a planar projection.
    
      - type : t                       (unicode)       [create]
          Specify the type of mapping to be performed Valid values for the STRING are "planar" "cylindrical" "spherical" Default
          is planar
...
def applyMetadata(*args, **kwargs):
    ...
    The specific serialization type will be the default 'raw' if the formatflag is not used. For example the "raw" format
    input string "channel face\n[STREAMDATA]\nendChannels\nendAssociations" with no flags is equivalent to the input
    ...
    Flags:
      ...
      - value : v                      (unicode)       [create]
          String containing all of the metadata to be assigned to the selected object.Flag can appear in Create mode of
          commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def subdMatchTopology(*args, **kwargs):
    ...
    Flags:
      - frontOfChain : foc             (bool)          [create]
          ...
          downstream deformers are in their reset (hasNoEffect) position when the new deformer is added.Flag can appear in Create
          mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def pointCurveConstraint(*args, **kwargs):
    ...
    subsequent interactive manipulation of the curve. The locator position may be key framed or transformed and the "curve1"
    ...
    Flags:
      ...
      - pointWeight : pw               (float)         [create,query,edit]
          Point constraint weight. Determines how strong an influence the constraint has on the input NURBS
          object.Default:1.0Advanced flags
      ...
      - weight : w                     (float)         [create]
          weight of the lsq constraint. The larger the weight, the least squares constraint is strictly met.Common flags
...
def polySmooth(*args, **kwargs):
    ...
    Flags:
      ...
      - continuity : c                 (float)         [create,query,edit]
          ...
          subdivided. Maximum value of 1.0 smooths the faces as much as possible.C: Default is 1.0Q: When queried, this flag
          returns a float.
      ...
      - keepSelectionBorder : ksb      (bool)          [create,query,edit]
          If true, vertices on border of the selection will not be modified.C: Default is false.Q: When queried, this flag returns
          a boolean.
      ...
      - propagateEdgeHardness : peh    (bool)          [create,query,edit]
          If true, edges which are a result of smoothed edges will be given the same value for their edge hardness. New subdivided
          edges will always be smooth.C: Default is false.Q: When queried, this flag returns a boolean.
...
def hasMetadata(*args, **kwargs):
    ...
    containing metadata. This combines with the filter flags as follows: no flag- True if there is any metadata at all on
    the node or scenechannelName- True if there is any metadata at all on the Channel with the given namestreamName- True if
    there is any metadata at all on the Stream with the given nameindex/startIndex/endIndex- An array of booleans ordered
    the same as the natural ordering of the Index values (i.e. specifying index 3, 2, and 4 in that order will still return
    booleans in the order for indices 2,3,4) where True means that there is metadata assigned at that Index. This form is
    better suited with the asListmodification since with that variation it is easier to tell exactly which indices have the
    metadata.asList- Adding this flag switches the return values from a single boolean or array of booleans to an array of
    strings indicating exactly which metadata elements have values. The return values of the command are changed to be the
    following: no flag- List of Channel names with metadatachannelName- List of Stream names in the Channel with
    metadatastreamName- List of Index values on the Stream with metadataindex/startIndex/endIndex- List of Index values with
    ...
    Flags:
      ...
      - index : idx                    (unicode)       [create,query]
          ...
          e.g. a "vertexFace" component will use a "pair" index type, which is two integer values; one for the face ID of the
          component and the second for the vertex ID. The indexflag takes a string, formatted in the way the specified
          indexTyperequires. All uses of the indexflag have the same indexType. If the type was not specified it is assumed to be
          a simple integer value. In query mode, this flag can accept a value.
      ...
      - memberName : mn                (unicode)       [create]
          ...
          through the description passed in through the "dataStructure" command or via the API used to create that Structure. As
          the assignment of metadata is on a per-structure basis this flag only needs to be specified when querying for non-
          default values. If you query for non-default values and omit this flag then it checks that any of the members have a
          non-default value.
      ...
      - streamName : stn               (unicode)       [create,query]
          ...
          Stream to pass through the filter. In query mode, this flag can accept a value.Flag can appear in Create mode of
          commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def plane(*args, **kwargs):
    ...
    Flags:
      ...
      - name : n                       (unicode)       [create]
          Name the resulting objectFlag can appear in Create mode of commandFlag can have multiple arguments, passed either as a
          tuple or a list.
...
def polyInstallAction(*args, **kwargs):
    ...
    Flags:
      ...
      - keepInstances : ki             (bool)          [create]
          Convert components for all selected instances rather than only the first selected instance.Flag can appear in Create
          mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def polyCheck(*args, **kwargs):
    ...
    Flags:
      ...
      - openFile : of                  (unicode)       [create]
          Opens a file that contains a poly description, as dumped out by the debug commands.Flag can appear in Create mode of
          commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def roundConstantRadius(*args, **kwargs):
    ...
    surfaces. Use the "-sa" and "-sb" flags in this case. The results from this command are three surface var groups plus
    the name of the new roundConstantRadius dependency node, if history was on. The 1st var group contains trimmed copies of
    the original surfaces. The 2nd var group contains the new NURBS fillet surfaces. The 3rd var group contains the new
    NURBS corners (if any). A simple example of an edge pair is an edge of a NURBS cube, where two faces of the cube meet.
    This command generates a NURBS fillet at the edge and trims back the faces. Another example is a NURBS cylinder with a
    planar trim surface cap. This command will create a NURBS fillet where the cap meets the the cylinder and will trim back
    the cap and the cylinder. Another example involves all 12 edges of a NURBS cube. NURBS fillets are created where any
    face meets another face. NURBS corners are created whenever 3 edges meet at a corner.
    ...
    Flags:
      ...
      - radiuss : rad                  (float)         [create]
          Use this flag to specify radius. This overrides the "r/radius" flag. If only one "rad" flag is used, then it is applied
          to all edge pairs. If 1 "rad" flag is used, then the number of "-rad" flags must equal the number of edge pairs. For
          example, for four edge pairs, you must specify zero, one or four "rad" flags.
      ...
      - side : s                       (unicode, int)  [create]
          ...
          must be either "a" or "b". You must specify the same number of "a" values as "b" values. If no sides are specified with
          the "side" flag (or sidea/sideb flags), then the edges are assumed to be in pairs. See also examples below. For example,
          two faces of a cube meet at an edge pair. Suppose one of the faces is then split in two pieces at the middle of the
          edge, so that there is one face on side "A", and two pieces on side "B". In this case you would use the flag
          combination: -side "a" 1 -side "b" 2. You must specify the edges in the corresponding order: // MEL roundConstantRadius
          -side "a" 1 -side "b" 2 isoA isoB1 isoB2; # Python maya.cmds.roundConstantRadius( 'isoA', 'isoB1', 'isoB2',
          side=[("a",1), ("b",2)] )Flag can appear in Create mode of commandFlag can have multiple arguments, passed either as a
          tuple or a list.
    
      - sidea : sa                     (int)           [create]
          Use this flag for compound edges in conjunction with the following "-sb" flag. This flag is not intended for use from
          Python. Please see "side" flag instead. You must specify the same number of "-sa" flags as "-sb" flags. If no "-sa" nor
          "-sb" flags are specified, then the edges are assumed to be in pairs. See also examples below. For example, two faces of
          a cube meet at an edge pair. Suppose one of the faces is then split in two pieces at the middle of the edge, so that
          there is one face on side "A", and two pieces on side "B". In this case you would use the flag combination: -sidea 1
          -sideb 2. You must specify the edges in the corresponding order: roundConstantRadius -sidea 1 -sideb 2 isoA isoB1 isoB2;
    
      - sideb : sb                     (int)           [create]
          Use this flag for compound edges in conjunction with the "-sa" flag. See description for the "-sa" flag. This flag is
          not intended for use from Python. Please see "side" flag instead.
...
def polySoftEdge(*args, **kwargs):
    """
    Selectively makes edges soft or hard.An edge will be made hard if the angle between two owning faces is sharper (larger)
    than the smoothing angle.An edge wil be made soft if the angle between two owning facets is flatter (smaller) than the
    smoothing angle.
...
def subdCleanTopology(*args, **kwargs):
    ...
    following conditions: - Zero edits - Default uvs (uvs obtained by subdividing parent face). - No creases.
...
def boundary(*args, **kwargs):
    ...
    "endPoint" option is on, then the curve endpoints must touch before a surface will be created. This is the usual
...
def pointPosition(*args, **kwargs):
    ...
    Flags:
      - local : l                      (bool)          [create]
          Return the point in local space coordinates.Flag can appear in Create mode of commandFlag can have multiple arguments,
          passed either as a tuple or a list.
...
def alignCurve(*args, **kwargs):
    ...
    Flags:
      ...
      - positionalContinuityType : pct (int)           [create,query,edit]
          ...
          first curve, 5 - modify second curve, 6 - modify both curvesDefault:1
      ...
      - reverse1 : rv1                 (bool)          [create,query,edit]
          ...
          aligning. NOTE: setting this attribute to random values will cause unpredictable results and is not
          supported.Default:false
...
def polyAutoProjection(*args, **kwargs):
    ...
    Flags:
      ...
      - projectBothDirections : pb     (bool)          [create,query,edit]
          ...
          projections are not mirrored on opposite faces.C: Default is "off".Q: When queried, this flag returns an integer.Global
          Values
      ...
      - worldSpace : ws                (bool)          [create,query,edit]
          This flag specifies which reference to use. If "on" : all geometrical values are taken in world reference. If "off" :
          all geometrical values are taken in object reference.C: Default is "on".Q: When queried, this flag returns an integer.
...
def changeSubdivComponentDisplayLevel(*args, **kwargs):
    ...
    Flags:
      ...
      - relative : r                   (bool)          [create,query]
          If set, level refers to the relative display levelFlag can appear in Create mode of commandFlag can have multiple
          arguments, passed either as a tuple or a list.
...
def subdLayoutUV(*args, **kwargs):
    ...
    Flags:
      ...
      - layout : l                     (int)           [create,query,edit]
          How to move the UV pieces, after cuts are applied:0 No move is applied.1 Layout the pieces along the U axis.2 Layout the
      ...
      - worldSpace : ws                (bool)          [create,query,edit]
          If true, performs the operation in world space coordinates as opposed to local space.Flag can appear in Create mode of
          commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def smoothTangentSurface(*args, **kwargs):
    ...
    for tangent will just give you tangent continuity.It should be mentioned that this is "C", not "G" continuity we're
    talking about, so technically, you can still see visual tangent breaks if the surface is degenerate. Note: A single
    ...
    Flags:
      ...
      - direction : d                  (int)           [create,query,edit]
          Direction in which to smooth knot: 0 - V direction, 1 - U directionDefault:1
      ...
      - smoothness : s                 (int)           [create,query,edit]
          Smoothness to get: 0 - Tangent, 1 - Maximum (based on the degree)Default:1Advanced flags
...
def polyPipe(*args, **kwargs):
    ...
    Flags:
      ...
      - createUVs : cuv                (bool)          [create,query,edit]
          This flag alows a texture to be applied.C: Default is "on" (uv's are computed).Q: When queried, this flag returns an
          int.
...
def editMetadata(*args, **kwargs):
    ...
    This provides an easy method to set or remove a bunch of metadata en masse. The general usage (variations 3, 4) lets you
    select specific pieces of metadata through the channelNameand indexflags. Note that since indexis a multi-use flag you
    can select many different elements from the same Channel and set or remove the metadata on all of them in one command.
    Metadata on meshes is special in that the Channel types "vertex", "edge", "face", and "vertexFace" are directly
    ...
    Flags:
      ...
      - memberName : mn                (unicode)       [create]
          ...
          through the description passed in through the "dataStructure" command or via the API used to create that Structure.
      ...
      - remove : rem                   (bool)          [create]
          ...
          "value", and "stringValue" flags are ignored. "memberName" is ignored because when deleting metadata all members of a
          structure must be removed as a group. The others are ignored since when deleting you don't need a value to be set.
...
def polySelectConstraint(*args, **kwargs):
    ...
    Flags:
      ...
      - anglebound : ab                (float, float)  [create,query]
          min and max angles. The given value should be in the current units that Maya is using. See the examples for how to check
          the current unit.For vertices : angle between the 2 edges owning the vertex.For edges : angle between the 2 faces owning
          the edge.
      ...
      - edgeDistance : ed              (int)           [create]
          Maximum distance (number of edges) to extend the edge selection for "Contiguous Edges" propagate mode. 0 means to ignore
      ...
      - mode : m                       (int)           [create,query]
          0(Off) 1(Next) 2(Current and Next) 3(All and Next).Off : no constraints are used at all.Next : constraints will be used
          to filter next selections.Current and Next : constraints will be aplied on current selection and then used to filter
          next selections.All and Next : all items satisfying constraints are selected.
      ...
      - propagate : pp                 (int)           [create,query]
          0(Off) 1(More) 2(Less) 3(Border) 4(Contiguous Edges).More : will add current selection border to current selection.Less
          : will remove current selection border from current selection.Border : will keep only current selection
          border.Contiguous Edges : Add edges aligned with the current edges selected. The direction and number of edges selected
          is controlled by the -m2a, -m3a, and -ed flags.
    
      - random : r                     (int)           [create,query]
          0(off) 1(on).
    
      - randomratio : rr               (float)         [create,query]
          ratio [0,1].Flag can appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple or a
          list.
      ...
      - wholeSensitive : ws            (bool)          [create,query]
          Tells how to select faces : eitherby picking anywhere inside the face (if true)or by picking on the face center marker
          (if false).
...
def polySlideEdge(*args, **kwargs):
    ...
    Flags:
      - absolute : a                   (bool)          [create]
          ...
          distance (the specified percentage of the smallest edge)C: Default is offFlag can appear in Create mode of commandFlag
          can have multiple arguments, passed either as a tuple or a list.
      ...
      - edgeDirection : ed             (float)         [create]
          This flag specifies the relative percentage to move along the edges on either side of the vertices along the edge loopC:
          Default is 0.0
...
def nurbsBoolean(*args, **kwargs):
    ...
    Flags:
      ...
      - smartConnection : sc           (bool)          [create]
          Look for any of the selection items having a boolean operation as history.Default is true.Flag can appear in Create mode
          of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def changeSubdivRegion(*args, **kwargs):
    ...
    Flags:
      ...
      - level : l                      (int)           [create]
          Specify the level of the subdivision surface to perform the operationFlag can appear in Create mode of commandFlag can
          have multiple arguments, passed either as a tuple or a list.
...
def bezierAnchorState(*args, **kwargs):
    ...
    Flags:
      - even : ev                      (bool)          [create]
          Sets selected anchors (or attached tangent handles) to even weighting when true, uneven otherwise.Flag can appear in
          Create mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def globalStitch(*args, **kwargs):
    """
    This command computes a globalStitch of NURBS surfaces. There should be at least one NURBS surface. The NURBS surface(s)
    should be untrimmed.
    ...
    Flags:
      ...
      - nodeState : nds                (int)           [create,query,edit]
          Modifies the node state. See the node documentation for more information.Note:For advanced users only.Flag can appear in
          Create mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def polySphere(*args, **kwargs):
    ...
    Flags:
      ...
      - createUVs : cuv                (int)           [create]
          ...
          implies that no UVs will be generated (No texture to be applied).1 implies UVs are created with pinched at poles2
          implies UVs are created with sawtooth at polesFor better understanding of these options, you may have to open thetexture
      ...
      - subdivisionsX : sx             (int)           [create,query,edit]
          This specifies the number of subdivisions in the X direction for the sphere.C: Default is 20.Q: When queried, this flag
          returns an int.
    
      - subdivisionsY : sy             (int)           [create,query,edit]
          This flag specifies the number of subdivisions in the Y direction for the sphere.C: Default is 20.Q: When queried, this
          flag returns an int.
...
def subdMapSewMove(*args, **kwargs):
    ...
    Flags:
      ...
      - constructionHistory : ch       (bool)          [create,query]
          Turn the construction history on or off (where applicable).Q: When queried, this flag returns an int.Flag can appear in
          Create mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def rebuildSurface(*args, **kwargs):
    ...
    Flags:
      ...
      - fitRebuild : fr                (int)           [create,query,edit]
          ...
          based fit algorithm.Default:0Advanced flags
    
      - keepControlPoints : kcp        (bool)          [create,query,edit]
          Use the control points of the input surface. This forces uniform parameterization unless rebuildType is 2 (match
          knots)Default:false
      ...
      - keepRange : kr                 (int)           [create,query,edit]
          ...
          the original surface parameterization; 2 - reparameterize the result from 0 to number of spansDefault:1
      ...
      - rebuildType : rt               (int)           [create,query,edit]
          ...
          rebuild ends 6 - trim convert (uniform) 7 - into Bezier meshDefault:0
...
def polyGeoSampler(*args, **kwargs):
    ...
    overridden using a "flat" shading option. This option basically means to always use the normals of the faces when
    computing sampling values. This may be a desired if the user wishes to override an edge smoothness factor. Basically
    with the "flat" shading option on, edges are always considered to be hard. Note that displacement sampling will result
    in the -sampleByFace option to be turned off, since a displacement of a vertex always affects the faces the vertex is
    connected to. Finally, it is possible to force the storage of shared colors per vertex, and / or force the usage of
    unshared UV values. The computation of the resulting color is as follows: resulting-RGB = (sampled-RGB \* scale-factor);
    if (color blend is none)                 resulting-RGB = geometry-RGB         else if (color blend is add)
    ...
    Flags:
      - alphaBlend : abl               (unicode)       [create,edit]
          When specified, indicates the type of alpha blend to be applied. Options are: "none", "overwrite", "add", "subtract",
          "multiply", "divide", "average". This option only applies when colors are being set. The default if this argument is not
          specified is "overwrite". The "none" options to not overwrite the existing value.
      ...
      - colorBlend : cbl               (unicode)       [create,edit]
          When specified, indicates the type of color blend to be applied. Options are: "none", "overwrite", "add", "subtract",
          "multiply", "divide", "average". This option only applies when colors are being set. The default if this argument is not
          specified is "overwrite". The "none" options to not overwrite the existing value.
    
      - colorDisplayOption : cdo       (bool)          [create,edit]
          Change the display options on the mesh to display the vertex colors.Flag can appear in Create mode of commandFlag can
          have multiple arguments, passed either as a tuple or a list.
...
def polySplit(*args, **kwargs):
    ...
    Flags:
      ...
      - edgepoint : ep                 (int, float)    [create]
          The given edge is split into two new edges by inserting a new vertex located the given percentage along the
          edge.Note:This flag is not recommended for use from Python. See the insertpoint flag instead.
...
def polyAverageNormal(*args, **kwargs):
    ...
    Flags:
      ...
      - replaceNormalXYZ : xyz         (float, float, float) [create]
          If the allowZeroNormalis false, this value is used to replace the zero normals. By default it is (1, 0, 0).Flag can
          appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def nurbsSelect(*args, **kwargs):
    ...
    Flags:
      - borderSelection : bs           (bool)          [create]
          Extract the border of the current CV selection.Flag can appear in Create mode of commandFlag can have multiple
          arguments, passed either as a tuple or a list.
...
def subdPlanarProjection(*args, **kwargs):
    ...
    Flags:
      ...
      - createNewMap : cm              (bool)          [create,query,edit]
          This flag when set true will create a new map with a the name passed in, if the map does not already exist.Flag can
          appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def polyAppendVertex(*args, **kwargs):
    ...
    Flags:
      - append : a                     (float, float, float) [create]
          ...
          the "hole", "vertex" and "point" flags. If no argument is passed to the "append" flag, then it marks the beginning of a
          hole (use an empty tuple in Python '()'). If one argument is passed, then the argument is considered to be an index into
          the vertices of the selected object, as with the "vertex" flag. If three arguments are passed, then it is interpreted as
          the coordinates of a new point which will be inserted, as with the "point" flag.
      ...
      - hole : h                       (bool)          [create]
          Add a hole. The following points and edges will define a hole. Note that this flag should be avoided in Python. You may
          use the "append" flag instead and pass an empty tuple '()' to specify the start of a hole.Common flags
      ...
      - vertex : v                     (int)           [create]
          ...
          use the "append" flag instead and pass one argument.
...
def nurbsToPoly(*args, **kwargs):
    ...
    Flags:
      ...
      - normalizeTrimmedUVRange : ntr  (bool)          [query,edit]
          ...
          surface.) When false, the UV texture coordinates on the trimmed input surface are applied to the output surface as they
          are for the trimmed input surface. (Only the texture coordinates visible on the trimmed input surface are mapped to the
          output surface.)Default:trueCommon flags
...
def bevelPlus(*args, **kwargs):
    ...
    should be the "outside" curve, and the (optional) rest of them should be inside of the first one. For predictable
    ...
    Flags:
      ...
      - polyOutChordHeightRatio : chr  (float)         [create,query,edit]
          ...
          description of chord height.) Used if Method is Sampling and polyOutUseChordHeightRatio is true.Default:0.1Flag can
          appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
      ...
      - polyOutExtrusionType : pet     (int)           [create,query,edit]
          Initial type tessellation criteria along the extrude direction. Used only if Method is Sampling. 2 - Complete Extrusion.
          This type places a specific number of lines across the surface, equally spaced in parameter space.3 - Extrusion Section.
          This type places a specific number of lines across each surface span, equally spaced in parameter space.Default:3
...
def polyQuad(*args, **kwargs):
    ...
    Flags:
      ...
      - keepGroupBorder : kgb          (bool)          [create,query,edit]
          Keep facet group border : If "on", the borders of selected faces are maintained, otherwise the borders of selected
          facets may be modified.C: Default is "on".Q: When queried, this flag returns an int.
...
def angleBetween(*args, **kwargs):
    ...
    Flags:
      ...
      - constructionHistory : ch       (bool)          [create]
          Turn construction history on or off. If true, a dependency node will be created and its name is
          returned.Default:falseFlag can appear in Create mode of commandFlag can have multiple arguments, passed either as a
          tuple or a list.
...
def polyHole(*args, **kwargs):
    ...
    Flags:
      - assignHole : ah                (bool)          [create,query,edit]
          ...
          faces to be hole.Flag can appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple or
          a list.
...
def polyAverageVertex(*args, **kwargs):
    ...
    Flags:
      ...
      - worldSpace : ws                (bool)          [create,query,edit]
          This flag specifies which reference to use. If "true" : all geometrical values are taken in world reference. If "false"
          : all geometrical values are taken in object reference.C: Default is "false".Common flags
...
def manipOptions(*args, **kwargs):
    ...
    Flags:
      ...
      - preselectHighlight : psh       (bool)          [create,query]
          Set whether manip handles should be highlighted when moving mouse.Flag can appear in Create mode of commandFlag can have
          multiple arguments, passed either as a tuple or a list.
...
def closeSurface(*args, **kwargs):
    ...
    Flags:
      - blendBias : bb                 (float)         [create,query,edit]
          Skew the result toward the first or the second surface depending on the blend value being smaller or larger than
          0.5.Default:0.5
...
def transferShadingSets(*args, **kwargs):
    ...
    Flags:
      ...
      - searchMethod : sm              (int)           [create,query,edit]
          Specifies which search method to use when correlating points. 0 is closest along normal, 3 is closest to point. The
          default is closest to point.Flag can appear in Create mode of commandFlag can have multiple arguments, passed either as
          a tuple or a list.
...
def polyWedgeFace(*args, **kwargs):
    ...
    may not look intuitive. To separately wedge faces about different wedge axes, the command should be issued as many times
    ...
    Flags:
      ...
      - worldSpace : ws                (bool)          [create,query,edit]
          This flag specifies which reference to use. If "on" : all geometrical values are taken in world reference. If "off" :
          all geometrical values are taken in object reference.C: Default is off.Q: When queried, this flag returns an int.Common
          flags
...
def polyCrease(*args, **kwargs):
    ...
    Flags:
      ...
      - operation : op                 (int)           [create,query,edit]
          ...
          specified components. 2: Remove all crease values from the mesh. Default is 0.Flag can appear in Create mode of
          commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def polyInfo(*args, **kwargs):
    ...
    Flags:
      ...
      - faceNormals : fn               (bool)          [create]
          ...
          faces. Else it returns the face normals of all the faces of the object.Flag can appear in Create mode of commandFlag can
          have multiple arguments, passed either as a tuple or a list.
...
def polyUVSet(*args, **kwargs):
    """
    Command to do the following to uv sets: - delete an existing uv set. - rename an existing uv set. - create a new empty
    uv set. - copy the values from one uv set to a another pre-existing uv set. - set the current uv set to a pre-existing
    uv set. - modify sharing between instances of per-instance uv sets - query the current uv set. - set the current uv set
    to the last uv set added to an object. - query the names of all uv sets.
    ...
    Flags:
      ...
      - currentPerInstanceUVSet : cpi  (bool)          [query,edit]
          ...
          the set family that corresponds to the currently select instance.Flag can appear in Create mode of commandFlag can have
          multiple arguments, passed either as a tuple or a list.
...
def nurbsEditUV(*args, **kwargs):
    ...
    Flags:
      - angle : a                      (float)         [create,query]
          Specifies the angle value (in degrees) that the uv values are to be rotated by.Flag can appear in Create mode of
          commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def detachCurve(*args, **kwargs):
    ...
    pieces to keep and which to discard using the "-k" flag. The names of the newly detached curve(s) is returned. If
    history is on, then the name of the resulting dependency node is also returned. You can use this command to open a
    periodic curve at a particular parameter value. You would use this command with only one "-p" flag. If you are
    specifying "-k" flags, then you must specify one, none or all "-k" flags. If you are specifying all "-k" flags, there
    ...
    Flags:
      ...
      - keep : k                       (bool)          [create,query,edit]
          ...
          multattribute.Default:trueAdvanced flags
...
def polyMergeVertex(*args, **kwargs):
    ...
    Flags:
      ...
      - distance : d                   (float)         [create,query,edit]
          This flag specifies the distance within which vertices will be merged.C: Default is 0.0 (i.e. vertices are
          coincident).Q: When queried, this flag returns a double.
      ...
      - mergeToComponents : mtc        (unicode)       [create,query,edit]
          ...
          the center point of the set components will be calculated and all vertices will be merged to that location.C: Default is
          empty string.Q: When queried, this flag returns a string.Common flags
      ...
      - texture : tx                   (bool)          [create,query,edit]
          This flag specifies whether the texture is sewn in addition to the 3d edgeC: Default is true.Q: When queried, this flag
          returns a boolean.
...
def polyBevel(*args, **kwargs):
    ...
    Flags:
      ...
      - offsetAsFraction : oaf         (bool)          [create,query,edit]
          ...
          and 1, where 1 is the maximum possible offsetC: Default is false.Q: When queried, this flag returns an int.
      ...
      - segments : sg                  (int)           [create,query,edit]
          This flag specifies the number of segments used for the bevelling.C: Default is 1.Q: When queried, this flag returns an
          int.
...
def polyTorus(*args, **kwargs):
    ...
    Flags:
      ...
      - subdivisionsX : sx             (int)           [create,query,edit]
          This specifies the number of subdivisions in the X direction for the torus (number of sections).C: Default is 20.Q: When
...
def polyCreateFacet(*args, **kwargs):
    ...
    Flags:
      ...
      - point : p                      (float, float, float) [create]
          Adds a new point to the face. Coordinates of points are given in world reference. The point flag may also be passed with
          no arguments. That indicates that the following points will specify a hole. Passing the point flag with no arguments is
          the same as using the "hole" flag, except that it will work in Python.
      ...
      - texture : tx                   (int)           [create,query,edit]
          Specifies how the face is mapped.0 - None; 1 - Normalize; 2 - UnitizeC: Default is 0 (no mapping).Q: When queried, this
          flag returns an int
...
def filletCurve(*args, **kwargs):
    ...
    Flags:
      ...
      - blendControl : bc              (bool)          [create,query,edit]
          If true then depth and bias can be controlled. Otherwise, depth and bias are not available options.Default:falseAdvanced
          flags
...
def polyMirrorFace(*args, **kwargs):
    ...
    Flags:
      ...
      - mergeMode : mm                 (int)           [create]
          ...
          vertices will be present).If the mode is 1, the border vertices/edges will be mergedIf the mode is 2, the border edges
          will be extruded and connected.C: Default is 0
    
      - mergeThreshold : mt            (float)         [create]
          This flag specifies the tolerance value for merging borders.C: Default is 0.1Common flags
...
def polyBlindData(*args, **kwargs):
    ...
    blind data. So, the command will require the following to be specified: - typeId, - associationType - longDataName or
    shortDataName of data being edited. - The actual data being specified. - The components that this data is to be attached
    to.
    
    Flags:
      - associationType : at           (unicode)       [create,edit]
          Specifies the dataTypes that are part of BlindData node being created. Allowable associations are "object" for any
          object, and "vertex" "edge" and "face" for mesh objects. Other associations for other geometry types may be added.
    
      - binaryData : bnd               (unicode)       [create,edit]
          Specifies the data type is a binary data valueFlag can appear in Create mode of commandFlag can have multiple arguments,
          passed either as a tuple or a list.
...
def freeFormFillet(*args, **kwargs):
    ...
    Flags:
      - bias : b                       (float)         [create,query,edit]
          Bias value for filletDefault:0.5Advanced flags
      ...
      - depth : d                      (float)         [create,query,edit]
          Depth value for filletDefault:0.5
      ...
      - positionTolerance : pt         (float)         [create,query,edit]
          C(0) Tolerance For Filleted Surface creationDefault:0.1
      ...
      - tangentTolerance : tt          (float)         [create,query,edit]
          G(1) continuity Tolerance For Filleted Surface creationDefault:0.1
...
def polySetToFaceNormal(*args, **kwargs):
    """
    This command takes selected polygonal vertices or vertex-faces and changes their normals. If the option userNormalis
    ...
    Flags:
      - setUserNormal : su             (bool)          [create]
          ...
          value. Otherwise the normal values will be the internal computing results. Default is false.Flag can appear in Create
          mode of commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def querySubdiv(*args, **kwargs):
    ...
    Flags:
      - action : a                     (int)           [create]
          Specifies the query parameter: 1 = find all tweaked verticies at level 2 = find all sharpened vertices at level 3 = find
          all sharpened edges at level 4 = find all faces at level If the attribute "level" is not specified then the query is
          applied to the current component display level. If the attribute level is specified then the query is applied to that
          level, either absolute or relative to the current level based on the "relative" flag state.
    
      - level : l                      (int)           [create]
          Specify the level of the subdivision surface on which to perform the operation.
    
      - relative : r                   (bool)          [create]
          If set, level flag refers to the level relative to the current component display level.Flag can appear in Create mode of
          commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def tolerance(*args, **kwargs):
    ...
    tolerance is also known as "positional" tolerance. Angular tolerance is also known as "tangential" tolerance. In query
    mode, return type is based on queried flag.
    
    Flags:
      - angular : a                    (float)         [create,query]
          Sets the angular, or "tangential" tolerance.Flag can appear in Create mode of commandFlag can have multiple arguments,
          passed either as a tuple or a list.
...
def polyDuplicateAndConnect(*args, **kwargs):
    ...
    Flags:
      ...
      - renameChildren : rc            (bool)          [create]
          rename the children nodes of the hierarchy, to make them unique.Flag can appear in Create mode of commandFlag can have
          multiple arguments, passed either as a tuple or a list.
...
def curveOnSurface(*args, **kwargs):
    ...
    "-r/replace" flag. You can append points to an existing curve-on-surface by using the "-a/append" flag. See also the
    curve command, which describes how to query curve attributes.
    ...
    Flags:
      ...
      - degree : d                     (float)         [create]
          The degree of the new curve. Default is 3. Note that you need degree+1 curve points to create a visible curve span, eg.
          you must place 4 points for a degree 3 curve.
      ...
      - periodic : per                 (bool)          [create]
          If on, creates a curve that is periodic. Default is off.Flag can appear in Create mode of commandFlag can have multiple
          arguments, passed either as a tuple or a list.
...
def polyBoolOp(*args, **kwargs):
    """
    This command creates a new poly as the result of a boolean operation on input polys : union, intersection,
    difference.Only for difference, the order of the selected objects is important :result = object1 - object2.If no objects
    are specified in the command line, then the objects from the active list are used.
...
def polyCylinder(*args, **kwargs):
    ...
    Flags:
      ...
      - subdivisionsY : sy             (int)           [create,query,edit]
          This flag specifies the number of subdivisions in the Y direction for the cylinder.C: Default is 1.Q: When queried, this
          flag returns an int.
    
      - subdivisionsZ : sz             (int)           [create,query,edit]
          This flag specifies the number of subdivisions in the Z direction for the cylinder.C: Default is 1.Q: When queried, this
          flag returns an int.
...
def subdToBlind(*args, **kwargs):
    ...
    Flags:
      - absolutePosition : ap          (bool)          [create]
          ...
          you could set it to true. False is the default and saves the offsets.Flag can appear in Create mode of commandFlag can
          have multiple arguments, passed either as a tuple or a list.
    
      - includeCreases : ic            (bool)          [create]
          If set, the creases get transfered as well. With it false, the subdivision surface created from the blind data + polygon
          will have lost all the craese information. The default is false.
      ...
      - includeZeroOffsets : izo       (bool)          [create]
          ...
          will also let you keep all created vertices in the conversion back to polys. This flag does not change the behaviour for
          the vertices up to and including level 2 as they're always created. If not set, only the edited vertices will be
...
def reverseSurface(*args, **kwargs):
    ...
    Flags:
      ...
      - direction : d                  (int)           [create,query,edit]
          The direction to reverse the surface in: 0 - U, 1 - V, 2 - Both U and V, 3 - SwapDefault:0Advanced flags
...
def polyDelEdge(*args, **kwargs):
    """
    Deletes selected edges, and merges neighboring faces. If deletion leaves winged vertices, they may be deleted as
    well.Notice : only non border edges can be deleted.
...
def polyListComponentConversion(*args, **kwargs):
    ...
    Flags:
      ...
      - vertexFaceAllEdges : vfa       (bool)          [create]
          ...
          Without this flag, the default behaviour is to only include one edge per face vertex.Flag can appear in Create mode of
          commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def polyPlatonicSolid(*args, **kwargs):
    ...
    Flags:
      ...
      - createUVs : cuv                (int)           [create]
          ...
          without any normalization.The solid will be unwrapped and then the texture will be appliedwithout any distortion.In the
          unwrapped solid, the shared edges will have shared UVs.2 implies UVs are created separately for each of the faces of the
          solid.3 implies the UVs should be normalized. This will normalize theU and V direction separately, thereby resulting in
          distortion of textures.4 implies UVs are created so that the texture will not be distorted when applied.The texture
          lying outside the UV range will be truncated (since that cannot besqueezed in, without distorting the texture.For better
          understanding of these options, you may have to open thetexture view windowC: Default is 4
...
def dataStructure(*args, **kwargs):
    ...
    Flags:
      - asFile : af                    (unicode)       [create,query]
          ...
          the 'format' flag.Flag can appear in Create mode of commandFlag can have multiple arguments, passed either as a tuple or
          a list.
      ...
      - format : fmt                   (unicode)       [create,query]
          Format of data to expect in the structure description. "raw" is supported natively and will be assumed if the format
          type is omitted. Others are available via plug-in. You can query the available formats by using this flag in query mode.
...
def polyChipOff(*args, **kwargs):
    ...
    Flags:
      ...
      - keepFacesTogether : kft        (bool)          [create,query,edit]
          This flag specifies how to chip off facets. If "on", facets are pulled together (connected ones stay connected),
          otherwise they are pulled independentely.C: Default is "on".Q: When queried, this flag returns an int.
...
def rebuildCurve(*args, **kwargs):
    ...
    Flags:
      ...
      - keepControlPoints : kcp        (bool)          [create,query,edit]
          If true, the CVs will remain the same. This forces uniform parameterization unless rebuildType is
          matchKnots.Default:false
      ...
      - keepRange : kr                 (int)           [create,query,edit]
          ...
          original curve parameterization, 2 - reparameterize the result from 0 to number of spansDefault:1
      ...
      - rebuildType : rt               (int)           [create,query,edit]
          ...
          5 - rebuild ends 6 - cleanDefault:0
...
def polyPrimitive(*args, **kwargs):
    ...
    Flags:
      ...
      - polyType : pt                  (int)           [create]
          This flag allows a specific primitive poly to be selected for creation of mesh,The valid values is 00 implies soccer
          ball to be created.C: Default is 0Common flags
...
def projectCurve(*args, **kwargs):
    ...
    Flags:
      ...
      - useNormal : un                 (bool)          [create,query,edit]
          True if the surface normal is to be used and false if the direction vector should be used instead.Default:falseAdvanced
          flags
...
def getMetadata(*args, **kwargs):
    ...
    or command line. When an Index is specified where data is not present the command fails with a message telling you which
    Index or Indices didn't have values. Use the hasMetadatacommand first to determine where metadata exists if you need to
    know in advance where to find valid metadata. Filter FlagschannelName- Only look for metadata on one particular Channel
    typestreamName- Only look for metadata on one particular named Stream. When used in conjunction with channelNamethen
    ignore Streams with a matching name but a different Channel typeindex- Only look for metadata on one or more specific
    Index values of a Stream. Requires use of the streamNameflag. Does not require the indexTypeflag as that will be
    inferred by the streamName.startIndex/endIndex- Same as indexbut using an entire range of Index values rather than a
    single one. Not valid for index types not supporting ranges (e.g. strings)indexType- Only look for metadata using a
    particular Index type. Can have its scope narrowed by other filter flags as well.memberName- The particular Member in
    the metadata in a Structure to retrieve. If this is not specified the Structure can only have a single Member.Metadata
    on meshes is special in that the Channel types "vertex", "edge", "face", and "vertexFace" are directly connected to the
    ...
    example the selection "myMesh.vtx[8:10]" corresponds to channelName = vertexand either index = 8, 9, 10as a multi-use
    flag or setIndex = 8, endIndex=10. Only a single node or scene and unique metadata Structure Member are allowed in a
    single command. This keeps the data simple at the possible cost of requiring multiple calls to the command to get more
    than one Structure Member's value. When the data is returned it will be in Index order with an entire Member appearing
    together. For example if you were retrieving float[3] metadata on three components you would get the nine values back in
    the order: index[0]-float[0], index[0]-float[1], index[0]-float[2], index[1]-float[0], index[1]-float[1],
    index[1]-float[2], index[2]-float[0], index[2]-float[1], index[2]-float[2]. In the Python implementation the float[3]
    values will be an array each so you would get back three float[3] arrays.
    ...
    Flags:
      ...
      - memberName : mn                (unicode)       [create]
          ...
          through the description passed in through the "dataStructure" command or via the API used to create that Structure. This
...
def curveIntersect(*args, **kwargs):
    ...
    intersection of the curves in a specific direction you must use BOTH the "-useDirection" flag and the "direction" flag.
    ...
    Flags:
      ...
      - direction : d                  (float, float, float) [query,edit]
          The direction that the input curves are projected in before intersecting. This vector is only used if "useDirection"
          flag is true.
      ...
      - tolerance : tol                (float)         [query,edit]
          ...
          within tolerance for an intersection to be returned.Default:0.001Flag can appear in Create mode of commandFlag can have
          multiple arguments, passed either as a tuple or a list.
...
def untrim(*args, **kwargs):
    ...
    Flags:
      ...
      - untrimAll : all                (bool)          [query,edit]
          if true, untrim all the trims for the surface else untrim only the last trimFlag can appear in Create mode of
          commandFlag can have multiple arguments, passed either as a tuple or a list.
...
def polyExtrudeVertex(*args, **kwargs):
    ...
    Flags:
      ...
      - length : l                     (float)         [create,query,edit]
          This flag specifies the length of the vertex extrusion.C: Default is 0Q: When queried, this flag returns a float.
      ...
      - width : w                      (float)         [create,query,edit]
          This flag specifies the width of the vertex extrusion.C: Default is 0Q: When queried, this flag returns a float.
    
      - worldSpace : ws                (bool)          [create,query,edit]
          This flag specifies which reference to use. If "on" : all geometrical values are taken in world reference. If "off" :
          all geometrical values are taken in object reference.C: Default is off.Q: When queried, this flag returns a int.Common
          flags
...
def polyForceUV(*args, **kwargs):
    """
    A set of functionalities can be called through this command. The input for this command is a set of faces. Based on the
    arguments passed, the UVs for these selected faces can be created.Project UVs based on the camera:(UV creation)Based on
    the current view direction/orientation, the UVs are generated and assigned to the faces. Any previously assigned UV
    information will be lost.Best Plane Projection:(UV creation)The UVs are computed based on the plane defined by the user,
    and is applied to the selected faces. This tool has 2 phases. In the first phase, the faces to be mapped (faces to which
    UVs are to be created) are selected. In the second phase, the points (vertices, CVs) that define the projecting plane
    are selected. Any previously assigned UV information will be lost.Unitize:(UV creation)A new set of unitized UVs are
    generated and assigned to the faces. Any previously assigned UV information will be lost.Unshare:(UV creation)Force the
    specified UV to be unshared by possibly creating new UVs. Any previously assigned UV information will be lost.
    ...
    Flags:
      ...
      - numItems : ni                  (int)           [create]
          This flag is only used for the best plane texturingof polygonal faces. This flag should be followed by a selection list.
          If not specified, the selected objects will be used (in the order they were selected).This flag specifies the number of
          items (leading) in the selection list that should be used for the mapping. The trailing items will be used for computing
          the plane (See example below). The best plane texturingis better suited for using interactively from within its context.
          You can type "setToolTo polyBestPlaneTexturingContext" in the command window OR (EditPolygons-Texture-BestPlaneTexturing
...
def polyClipboard(*args, **kwargs):
    ...
    Shader (shading engine) assignment. 2) Texture coordinate (UV) assignment. 3) Color value assignment. Any combination of
    attributes can be chosen for the copy or paste operation. If the attribute has not been copied to the clipboard, then
    ...
    Flags:
      - clear : cl                     (bool)          [create]
          When used, will mean to clear the specified attribute argument(s).Flag can appear in Create mode of commandFlag can have
          multiple arguments, passed either as a tuple or a list.
...
def polyPlane(*args, **kwargs):
    ...
    Flags:
      ...
      - createUVs : cuv                (int)           [create]
          ...
          will not be distorted when applied.The texture lying outside the UV range will be truncated (since that cannot
          besqueezed in, without distorting the texture.For better understanding of these options, you may have to open thetexture
          view windowC: Default is 2
...
def polyNormalPerVertex(*args, **kwargs):
    ...
    Flags:
      ...
      - deformable : deformable        (bool)          [create,query,edit]
          DEFAULT true OBSOLETE flag. This flag will be removed in the next release.Flag can appear in Create mode of commandFlag
          can have multiple arguments, passed either as a tuple or a list.
...
def polySplitVertex(*args, **kwargs):
    ...
    Flags:
      ...
      - worldSpace : ws                (bool)          []
          Not used by this commandCommon flags
...
def surface(*args, **kwargs):
    ...
    Flags:
      ...
      - point : p                      (float, float, float) [create]
          To specify non rational CV with (x, y, z) values. "linear" means that this flag can take values with units. Note that
          you must specify (degree+1) surface points in any direction to create a visible surface span. eg. if the surface is
          degree 3 in the U direction, you must specify 4 CVs in the U direction. Points are specified in rows of U and columns of
          V. If you want to incorporate units, add the unit name to the value, eg. "-p 3.3in 5.5ft 6.6yd"
    
      - pointWeight : pw               (float, float, float, float) [create]
          To specify rational CV with (x, y, z, w) values. "linear" means that this flag can take values with units. Note that you
          must specify (degree+1) surface points in any direction to create a visible surface span. eg. if the surface is degree 3
          in the U direction, you must specify 4 CVs in the U direction. Points are specified in rows of U and columns of V.Flag
...
def polyQueryBlindData(*args, **kwargs):
    ...
    be specified: - selection list to query Optional are the: - typeId - associationType - longDataName or shortDataName of
    data being queried. - The actual data being specified. - showComponent flag Note that for object level blind data, the
    showComponent flag will be ignored. If no components are selected, the assocation flag will be ignored and object level
    data will be queried.
    
    Flags:
      - associationType : at           (unicode)       [create]
          Specifies the dataTypes that are part of BlindData node being queried. Allowable associations are "object" for any
          object, and "vertex" "edge" and "face" for mesh objects.
      ...
      - showComp : sc                  (bool)          [create]
          ...
          this option will still cause all the attribute names to be printedFlag can appear in Create mode of commandFlag can have
          multiple arguments, passed either as a tuple or a list.
      ...
      - typeId : id                    (int)           [create]
          ...
          used. Will be in the format "object.component.attribute::typeId". If the typeId is specifed then the "::typeId" portion
          will not be output with the ShowComponents option.
...
def polyMultiLayoutUV(*args, **kwargs):
    ...
    Flags:
      ...
      - scale : sc                     (int)           [create]
          How to scale the pieces, after move:0 No scale is applied.1 Uniform scale to fit in unit square.2 Non proportional scale
          to fit in unit square.
...
def blend2(*args, **kwargs):
    ...
    Flags:
      - autoAnchor : aa                (bool)          [create,query,edit]
          If true and both paths are closed, automatically determine the value on the right rail so that they matchDefault:true
      ...
      - multipleKnots : mk             (bool)          [create,query,edit]
          If true, use the new blend which produces fully multiple interior knotsDefault:true
      ...
      - reverseLeft : rvl              (bool)          [create,query,edit]
          If true, reverse the direction off the left boundary. autoDirection must be false for this value to be
          considered.Default:false
    
      - reverseRight : rvr             (bool)          [create,query,edit]
          If true, reverse the direction of the right boundary. autoDirection must be false for this value to be
          considered.Default:falseAdvanced flags
...
def grid(*args, **kwargs):
    ...
    Flags:
      ...
      - style : st                     (int)           [query]
          This flag is obsolete and should not be used.Flag can appear in Create mode of commandFlag can have multiple arguments,
          passed either as a tuple or a list.
...
def polyCylindricalProjection(*args, **kwargs):
    ...
    Flags:
      ...
      - imageCenterX : icx             (float)         [create,query,edit]
          This flag specifies X of the center point of the 2D model layout.C: Default is 0.5.Q: When queried, this flag returns a
          float.
    
      - imageCenterY : icy             (float)         [create,query,edit]
          This flag specifies Y of the center point of the 2D model layout.C: Default is 0.5.Q: When queried, this flag returns a
          float.
      ...
      - projectionCenter : pc          (float, float, float) [create,query,edit]
          This flag specifies the point of origin from which the map is projected.C: Default is 0.0 0.0 0.0.Q: When queried, this
          flag returns a float[3].
    
      - projectionCenterX : pcx        (float)         [create,query,edit]
          This flag specifies the X of the origin's point from which the map is projected.C: Default is 0.0.Q: When queried, this
          flag returns a float.
    
      - projectionCenterY : pcy        (float)         [create,query,edit]
          This flag specifies the Y of the origin's point from which the map is projected.C: Default is 0.0.Q: When queried, this
          flag returns a float.
    
      - projectionCenterZ : pcz        (float)         [create,query,edit]
          This flag specifies the Z of the origin's point from which the map is projected.C: Default is 0.0.Q: When queried, this
          flag returns a float.
...
def subdivDisplaySmoothness(*args, **kwargs):
    ...
    Flags:
      - all : ()                       (bool)          [create,query]
          If set, change smoothness for all subdivision surfacesFlag can appear in Create mode of commandFlag can have multiple
          arguments, passed either as a tuple or a list.
...
def polyDuplicateEdge(*args, **kwargs):
    ...
    Flags:
      ...
      - smoothingAngle : sma           (float)         [create]
          Subdivide new edges will be soft if less then this angle.C: Default is 180.0Common flags
    
      - splitType : stp                (int)           [create,query,edit]
          Choose between 2 different types of splits. If this is set to 0 then the split type will be absolute. This is where each
          of the splits will maintain an equal distance from the associated vertices. If this set to 1 then the split type will be
          relative. This is where each split will be made at an equal percentage along the length of the edge.
...
def polySphericalProjection(*args, **kwargs):
    ...
    Flags:
      ...
      - projectionScaleU : psu         (float)         [create,query,edit]
          This flag specifies the width of the map relative to the 3D projection axis : the scale aperture. The range is [0,
          360].C: Default is 180.0.Q: When queried, this flag returns a float.
...
def polySewEdge(*args, **kwargs):
    ...
    Flags:
      ...
      - worldSpace : ws                (bool)          [create,query,edit]
          This flag specifies which reference to use. If "on" : tolerance value is taken in world reference. If "off" : tolerance
          value is considered in object reference.C: Default is "off".Q: When queried, this flag returns an int.Common flags
