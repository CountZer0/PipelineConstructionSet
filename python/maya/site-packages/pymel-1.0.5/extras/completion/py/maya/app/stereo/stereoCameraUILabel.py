...
class UILabel:
    ...
    def __init__(self, label=None, annotation=None, image=None, command=None, command_pack='<function pack_cmd>', command_args=[], command_keywords={}, option_box=False, check_box='', disabled=False, radio_cb=[], enable_cb=[]):
        pass
