...
class CreaseSetTreeWidget(QTreeWidget):
    ...
    def updateHighlightedItems(self):
        """
    ...
    def updateUI_objectSetMembersChanged(self, objectSetName):
        """
        Selectively update the widget tree for the specified creaseSet.
        This function is usually called by the objectSetMembersChangedCB callback when
